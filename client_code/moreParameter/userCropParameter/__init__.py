...
class userCropParameter(userCropParameterTemplate):
  ...
  def button_1_click(self, **event_args):
    ...
    built_inCrop={ "土豆":"Potato",
                   ...
                   "苜蓿GDD":"AlfalfaGDD",
                   "藜麦":"Quinoa"}
    media=anvil.server.call('downLoadCropParamsExcel',built_inCrop[self.cropName],self.userName)
    anvil.media.download(media)

  def file_loader_2_change(self, file, **event_args):
    """This method is called when a new file is loaded into this FileLoader"""
    # anvil.server.call('save_parameter_excel',self.file_loader_2.file,self.cropName)
    anvil.server.call('upload_crop_parameter',self.file_loader_2.file,self.cropName,self.userName)
